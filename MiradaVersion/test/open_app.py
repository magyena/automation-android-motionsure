...
def free_email_data():
    with open(
        ...
        "/Users/michaelliong/Documents/automation-android-python/MiradaVersion/utils/id_Mirada_TestData_Login/free_email.json"
    ) as file:
        data = json.load(file)
...
def premium_email_data():
    with open(
        ...
        "/Users/michaelliong/Documents/automation-android-python/MiradaVersion/utils/id_Mirada_TestData_Login/loginPremium.json"
    ) as file:
        data = json.load(file)
...
def premium_sport_email_data():
    with open(
        ...
        "/Users/michaelliong/Documents/automation-android-python/MiradaVersion/utils/id_Mirada_TestData_Login/premiumSport_email.json"
    ) as file:
        data = json.load(file)
...
def free_phone_data():
    with open(
        ...
        "/Users/michaelliong/Documents/automation-android-python/MiradaVersion/utils/id_Mirada_TestData_Login/free_phone.json"
    ) as file:
        data = json.load(file)
...
def premium_phone_data():
    with open(
        ...
        "/Users/michaelliong/Documents/automation-android-python/MiradaVersion/utils/id_Mirada_TestData_Login/premium_phone.json"
    ) as file:
        data = json.load(file)
    print("Loaded login data:", data)
    return data
...
def premium_sport_phone_data():
    with open(
        ...
        "/Users/michaelliong/Documents/automation-android-python/MiradaVersion/utils/id_Mirada_TestData_Login/sport_phone.json"
    ) as file:
        data = json.load(file)
    print("Loaded login data:", data)
    return data
...
def wrong_email_data():
    with open(
        ...
        "/Users/michaelliong/Documents/automation-android-python/MiradaVersion/utils/id_Mirada_TestData_Login/WrongEmail.json"
    ) as file:
        data = json.load(file)
...
def wrong_phone_data():
    with open(
        ...
        "/Users/michaelliong/Documents/automation-android-python/MiradaVersion/utils/id_Mirada_TestData_Login/WrongPhone.json"
    ) as file:
        data = json.load(file)
